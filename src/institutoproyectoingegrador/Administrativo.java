...
public class Administrativo extends Persona {
    ...
    public void cargarMateria(ArrayList<Materia> listaMaterias) {
        ...
        JOptionPane.showMessageDialog(null, "Materia cargado con éxito.");
    }
    ...
    public void mostrarAdministrativo() {
        ...
        // Mostrar datos específicos del Administrativo
        String mensajeAdministrativo = "Rol: " + rol + "\n"
                + "Turno de trabajo: " + horario + "\n"
                + "Estado: " + (activo ? "Activo" : "Inactivo") + "\n"
                + "Clave: " + clave + "\n"
                + "Password: " + pass;

        JOptionPane.showMessageDialog(null, mensajeAdministrativo);
    }
}
